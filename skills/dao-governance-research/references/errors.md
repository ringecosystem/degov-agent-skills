...
| 400  | `CURSOR_INVALID`                  | Malformed or unparseable cursor                                       | Drop the cursor and re-run                                                                     |
...
| 409  | `CURSOR_STALE`                    | Endpoint, limit, filters, or serving revision differ from the cursor  | Drop the cursor; a fresh paid request must remain within the approved query plan and cost cap  |
